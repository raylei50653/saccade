...
| 🤝 semantic | 🔄 active | Gap-conditioned probabilistic motion probe — E0–E1 `ACCEPTED_WITH_LIMITS`; next E2 position-only M1-P/M2-P family freeze | [↗](docs/modules/semantic/TODO.md) |
