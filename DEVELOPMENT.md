...
| 🤝 semantic | 🔄 active | Gap-conditioned probabilistic motion probe — E2 position-only family packet `FROZEN_PENDING_RESEARCH_ACCEPTANCE`; E3 unauthorized pending owner gate | [↗](docs/modules/semantic/TODO.md) |
