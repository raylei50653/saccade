...
* **[PROJECT_DIRECTION.md](PROJECT_DIRECTION.md)**：**專案級方向語義**。範式邊界、近程目標定義、長期戰略路徑進入/退出條件；不承載數字、狀態或進度。
...
* 🔬 **[research control plane](research/README.md#research-control-plane)**：跨模組實驗的型別、owner 路由與 evidence 入口；結構契約見 [ownership/doc_structure_contract.md](ownership/doc_structure_contract.md)。
...
| 🤝 **[semantic/](modules/semantic)** | Offline identity / Cheb-GR / bridge relink 研究主家（headline ReID off；critical-path ReID NO-GO #57） | * [模組 README · 研究全表](modules/semantic/README.md)<br>* [occ-exit 工作區](experiments/occ_exit_audit_p55/README.md)<br>* [offline relink hub](modules/semantic/research/offline_relink_candidate_analysis.md)<br>* ADR [015](decisions/015-sinkhorn-auction-hybrid-association.md) / [016](decisions/016-rerank-phase3-reference-quality.md) |
