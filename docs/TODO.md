...
- **NONE。** #368 Phase 1（module doc question map）已驗收：protocol 與輸出見下方跨模組待辦。Phase 2 / W-B / W-C 未授權，皆不自動啟動。
