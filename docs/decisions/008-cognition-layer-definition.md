...
## Trade-offs
- **Pros:** Clarifies the architectural role of `src/saccade/resource/` modules, ensuring they have a defined place in the system blueprint. Promotes better separation of concerns by keeping resource-aware throttling out of the core perception logic (L1/L2).
