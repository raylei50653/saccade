...
> 後續 `M4-a / M4-b` 的 runner / relink / output-path 收斂，另見 [docs/experiments/pipeline/gpu_pipeline_m4ab.md](/home/ray/developer/ai/saccade/docs/experiments/pipeline/gpu_pipeline_m4ab.md:1)。
