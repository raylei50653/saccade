...
| 文件 | 內容 |
|------|------|
| [research/boolean_atom_partial_order_20260711.md](research/boolean_atom_partial_order_20260711.md) | **PR-D gate partial-order audit（#106 / [PR #107](https://github.com/raylei50653/saccade/pull/107)）** · research acceptance **PENDING / UNDER REVIEW** · provisional operational map only · restricted-closure **BLOCKED** · packet [evidence/](research/evidence/boolean_atom_partial_order_20260711/manifest.json) · [thread](../../research/threads/gt_support_morphology_20260711.md) |
