...
| 文件 | 這是什麼 |
|------|------|
| [research/headline_bridge_full_decision_capture_declaration_20260713.md](research/headline_bridge_full_decision_capture_declaration_20260713.md) | H0：headline-s 完整 bridge decision-path capture 宣告 |
