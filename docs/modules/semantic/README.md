...
| 文件 | 內容 |
|------|------|
| [research/boolean_atom_partial_order_20260711.md](research/boolean_atom_partial_order_20260711.md) | **PR-D gate partial-order audit（#106 / [PR #107](https://github.com/raylei50653/saccade/pull/107)）** · terminal **`GLOBAL_PARTIAL_ORDER_READY`** · global=`{dist_h, log_h_ratio}` · `bridge_dist` conditional (motion-extrapolation) · motion conditional · `score_m_bridge`/`gap` context_only · packet [evidence/](research/evidence/boolean_atom_partial_order_20260711/manifest.json) · [thread](../../research/threads/gt_support_morphology_20260711.md) |
...
| [research/composition_grammar_t0_artifact_preflight_20260710.md](research/composition_grammar_t0_artifact_preflight_20260710.md) | **T0-A preflight** · schema/key map · 7-output derivability · G7 N · T0-B surface proposed only · [thread](../../research/threads/composition_grammar_safe_region.md) |
| [research/composition_grammar_t0_region_interpretation_20260710.md](research/composition_grammar_t0_region_interpretation_20260710.md) | **T0-B interpretation** · 154 PS geometry · radius≥1=0 · G7 contract-gap · [evidence](research/evidence/m_b1_5_t0_region_interpretation_20260710/) · [thread](../../research/threads/composition_grammar_safe_region.md) |
