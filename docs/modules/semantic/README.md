...
| 📋 **[research/association_tools.yaml](research/association_tools.yaml)** | **R registry partial_p0（Step 1B-1）**：Door A/D/F P0 tools + R-A/R-D/R-F；P1+ 未填；禁 metrics/verdict/knobs |
