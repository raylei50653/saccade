...
| 文件 | 這是什麼 |
|------|------|
| [research/safe_domain_runtime_transfer_declaration_20260712.md](research/safe_domain_runtime_transfer_declaration_20260712.md) | S0 sealed declaration：已接受的 safe 軸能否從 offline 座標轉移到 runtime 座標 |
