...
| 文件 | 內容 |
|------|------|
| [research/gt_support_morphology_step0_20260711.md](research/gt_support_morphology_step0_20260711.md) | **GT-Support Morphology Step-0 audit（sole active）** · per-cell risk field 不可識別（任何 k 僅 1 cell 達 ε≤0.05）· μ_GT = corner core M₀=97.1% + 4-track motion-atom escape tail（log_h_ratio 0/4）· verdict candidate `CORE_PLUS_CONDITIONAL_ESCAPE_TAIL`（exploratory, L1）· study `out/signal_study/gt_support_morphology_step0_20260711/` · [thread](../../research/threads/gt_support_morphology_20260711.md) · [procedure §19](../../research/eval/statistical_robust_feasible_set_estimation_under_asymmetric_loss.md) |
