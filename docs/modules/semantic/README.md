...
| 文件 | 內容 |
|------|------|
| [research/safe_region_r0_asset_contract_preflight_20260710.md](research/safe_region_r0_asset_contract_preflight_20260710.md) | **R0-A Region Asset Contract Preflight** · field/grain/ID derivability · G3 null proposal · R1 conditional on R0-B · **awaiting chat-side review** · [thread](../../research/threads/safe_region_assetization_20260710.md) |
