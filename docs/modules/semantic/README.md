...
| 文件 | 內容 |
|------|------|
| [research/boolean_atom_partial_order_20260711.md](research/boolean_atom_partial_order_20260711.md) | **PR-D gate partial-order audit（#106）** · terminal **`GLOBAL_PARTIAL_ORDER_READY`** · global=`{bridge_dist, dist_h, log_h_ratio}` · motion conditional · `score_m_bridge`/`gap` context_only · packet [evidence/](research/evidence/boolean_atom_partial_order_20260711/manifest.json) · [thread](../../research/threads/gt_support_morphology_20260711.md) |
