...
| [research/safe_region_asset_r1_conversion_20260710.md](research/safe_region_asset_r1_conversion_20260710.md) | **R1 conversion note** · A0 pack candidate under `out/signal_study/m_b1_5_safe_region_asset_r1_20260710/` · two-run determinism PASS · A1 not accepted · PR engineering review · [contract](../../research/eval/safe_region_asset_contract.md) · [thread](../../research/threads/safe_region_assetization_20260710.md) · [math](../../research/eval/statistical_robust_feasible_set_estimation_under_asymmetric_loss.md) · [boolean](../../research/eval/boolean_composition_semantics_contract.md) |
