...
- Frozen-substrate consequence: `tracker_gpu.hpp` / `tracker_gpu.cu` are strict sha256 inputs of the CLOSED packets; evolution path = [ADR 026](../../decisions/026-frozen-input-source-evolution.md)（[#436](https://github.com/raylei50653/saccade/issues/436) closed 2026-09-20, PR #450）; portable OR-tail hook accept/dispose = [#438](https://github.com/raylei50653/saccade/issues/438)（`Later`; #436 blocker resolved, not scheduled）.
