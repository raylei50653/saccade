...
- H0 full bridge-decision trace capture（Amendment 1 定義 §20.2/§20.8 repair；仍待 owner seal，未 seal 前不得執行或開下游 claim）→ [declaration](research/headline_bridge_full_decision_capture_declaration_20260713.md)
