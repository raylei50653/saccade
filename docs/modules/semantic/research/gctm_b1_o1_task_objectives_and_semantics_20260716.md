...
- **Upstream owners (unchanged).**
  ...
  the [GCTM task charter](../../../research/threads/closed/gap_conditioned_stochastic_transition_model_task.md)
...
### 0.1 Typed cross-layer object mapping

This is a shared relation card, not a duplicate mathematical specification or
an L2 policy. A relation type constrains what a downstream claim may inherit;
it does not turn a proposed object into a production object.

| Object | Authority | Relation to next object / runtime | Production role |
|:--|:--|:--|:--|
...
insertion policy or permit an eligibility, claim-arbitration, fallback, commit,
