...
3. Partial-order audit（PR-D gate / #106 · [PR #107](https://github.com/raylei50653/saccade/pull/107)）→ **UNDER REVIEW** · research acceptance **pending** · [note](boolean_atom_partial_order_20260711.md)。
4. Restricted-closure prototype — **BLOCKED** until #107 research acceptance。
