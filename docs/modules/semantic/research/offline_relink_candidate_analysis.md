...
> [signal_table_schema.md](../../../research/contracts/signal_table_schema.md) **§0.2–0.3**.
...
- **Signal-study contract (B1):** universe `U_relink_pair`, full+hard-pool AUC, base rate —
  see [signal_table_schema.md](../../../research/contracts/signal_table_schema.md) §0.1 / §4.3b
...
| **m B1 bridge discriminability (live)** | [`m_b1_research_history_20260709_20260710.md`](m_b1_research_history_20260709_20260710.md) | same B1 recipe on `mamba_whole_graph_m`; study_dir master | **RESEARCH** — full strong / hard mid; not production GO; s tables stay historical |
| **m B1 L0 gate coverage 7-seq** | [`m_b1_research_history_20260709_20260710.md`](m_b1_research_history_20260709_20260710.md) | production-shaped px/h coverage on offline pairs; gap+seq bins | **RESEARCH** — L0 coverage map; px=operating region, not safe-reject |
| **m B2 reconnect bridge ablate (live)** | [`m_b2_reconnect_bridge_ab_20260709.md`](m_b2_reconnect_bridge_ab_20260709.md) | online bridge on/off; reconnect_rate + e2e | **RESEARCH** — rate↑ / IDs↓ with bridge ON; B1≠B2 |
