...
| **m B1 bridge discriminability (live)** | [`m_b1_bridge_discriminability_20260709.md`](m_b1_bridge_discriminability_20260709.md) | same B1 recipe on `mamba_whole_graph_m`; study_dir master | **RESEARCH** — full strong / hard mid; not production GO; s tables stay historical |
| **m B1 L0 gate coverage 7-seq** | [`m_b1_gate_coverage_7seq_20260709.md`](m_b1_gate_coverage_7seq_20260709.md) | production-shaped px/h coverage on offline pairs; gap+seq bins | **RESEARCH** — L0 coverage map; px=operating region, not safe-reject |
