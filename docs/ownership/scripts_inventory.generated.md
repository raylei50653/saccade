...
Total tracked scripts: **446**. Source of truth = each script's own docstring + `# status:` header; regenerate with `scripts/tools/build_scripts_index.py`.
...
| Label | Meaning | Count |
|-------|---------|------:|
| `stable` | supported workflow entrypoint; keep path stable | 175 |
| `diagnostic` | reusable analysis/debug tool, not a main workflow | 165 |
