...
Total tracked scripts: **502**. Source of truth = each script's own docstring + `# status:` header; regenerate with `scripts/tools/build_scripts_index.py`.
...
| Label | Meaning | Count |
|-------|---------|------:|
| `stable` | supported workflow entrypoint; keep path stable | 186 |
| `diagnostic` | reusable analysis/debug tool, not a main workflow | 207 |
| `experiment` | tied to a named experiment or historical sweep | 103 |
...
### `scripts/benchmarks/resource_mixed/`
...
### `scripts/benchmarks/resource_mixed_db/`
...
### `scripts/benchmarks/resource_partition/`
...
### `scripts/benchmarks/resource_routing/`
...
### `scripts/benchmarks/resource_sensitivity/`
...
| `run_output_layer_repair_chaining.py` | experiment | cli | Measurement-only replay of output-layer identity-repair chaining. |
...
### `scripts/tools/capture_attribution/`
