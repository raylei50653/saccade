...
Total tracked scripts: **500**. Source of truth = each script's own docstring + `# status:` header; regenerate with `scripts/tools/build_scripts_index.py`.
...
| `diagnostic` | reusable analysis/debug tool, not a main workflow | 206 |
