...
Total tracked test files: **207**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `cross-module` | 0 | 5 | 0 | 0 | 0 | 5 |
| `system` | 0 | 58 | 4 | 1 | 1 | 64 |
| **Total** | 96 | 138 | 5 | 1 | 1 | **241** |
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 84 | 0 | 9 | 0 | 0 | 0 | 93 |
| `tracking` | 30 | 0 | 0 | 0 | 0 | 0 | 30 |
| `cross-module` | 5 | 0 | 0 | 0 | 0 | 0 | 5 |
| `system` | 64 | 0 | 0 | 0 | 0 | 0 | 64 |
| **Total** | 232 | 0 | 9 | 0 | 0 | 0 | **241** |
