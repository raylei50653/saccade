...
Total tracked test files: **186**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 53 | 4 | 1 | 1 | 59 |
| **Total** | 96 | 117 | 5 | 1 | 1 | **220** |
...
| `system` | 59 | 0 | 0 | 0 | 0 | 0 | 59 |
| **Total** | 211 | 0 | 9 | 0 | 0 | 0 | **220** |
