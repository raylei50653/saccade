...
Total tracked test files: **154**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 36 | 4 | 1 | 1 | 42 |
| **Total** | 94 | 74 | 5 | 1 | 1 | **175** |
...
| `system` | 42 | 0 | 0 | 0 | 0 | 0 | 42 |
| **Total** | 166 | 0 | 9 | 0 | 0 | 0 | **175** |
