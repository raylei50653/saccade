...
Total tracked test files: **210**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `storage` | 3 | 0 | 0 | 0 | 0 | 3 |
| `perception` | 11 | 1 | 1 | 0 | 0 | 13 |
| `detection` | 15 | 8 | 0 | 0 | 0 | 23 |
| `reid` | 3 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 49 | 44 | 1 | 0 | 0 | 94 |
| `tracking` | 8 | 22 | 0 | 0 | 0 | 30 |
| `cross-module` | 0 | 6 | 0 | 0 | 0 | 6 |
| `system` | 0 | 58 | 4 | 1 | 1 | 64 |
| **Total** | 96 | 140 | 6 | 1 | 1 | **244** |
...
| `perception` | 13 | 0 | 0 | 0 | 0 | 0 | 13 |
| `detection` | 23 | 0 | 0 | 0 | 0 | 0 | 23 |
| `reid` | 3 | 0 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 85 | 0 | 9 | 0 | 0 | 0 | 94 |
| `tracking` | 30 | 0 | 0 | 0 | 0 | 0 | 30 |
| `cross-module` | 6 | 0 | 0 | 0 | 0 | 0 | 6 |
| `system` | 64 | 0 | 0 | 0 | 0 | 0 | 64 |
| **Total** | 235 | 0 | 9 | 0 | 0 | 0 | **244** |
...
|------|-------|----------|-----------|---------|
| `test_adr_022_check_taxonomy.py` | system | contract | active | ADR 022's four representative cases, now asserting the taxonomy itself. |
...
| `test_asset_disposal.py` | system | contract | active | Contract for ADR 021 AP-5: disposal candidates, not deletion verdicts. |
...
| `test_h2_measurement_envelope.py` | tracking,system | contract | active | Independent v2 authority-envelope verification and corpus admission. |
...
| `test_h2_successor_authorization.py` | tracking,system | contract | active | Successor grant/receipt binding and exactly-once consumption contract. |
...
| `test_package_native_delivery.py` | system | contract | active | The native extension is delivered the way ADR 025 says, and the metadata agrees. |
...
| `test_training_eval_baselines.py` | detection | contract | active | Contract for #421 deliverable 4: a baseline row exists only behind a ``paired`` verdict. |
...
| `test_decode_producer_contract.py` | eval | contract | active | Producer→consumer contract of TorchvisionGpuStreamer's decode worker. |
...
| `test_torch_graphs_port.py` | eval | contract | active | The vendored ``make_graphed_callables`` port stays a transcription (#340). |
