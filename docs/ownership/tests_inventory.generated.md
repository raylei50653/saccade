...
Total tracked test files: **171**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 50 | 4 | 1 | 1 | 56 |
| **Total** | 95 | 103 | 5 | 1 | 1 | **205** |
...
| `system` | 56 | 0 | 0 | 0 | 0 | 0 | 56 |
| **Total** | 196 | 0 | 9 | 0 | 0 | 0 | **205** |
