...
Total tracked test files: **191**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 55 | 4 | 1 | 1 | 61 |
| **Total** | 96 | 122 | 5 | 1 | 1 | **225** |
...
| `system` | 61 | 0 | 0 | 0 | 0 | 0 | 61 |
| **Total** | 216 | 0 | 9 | 0 | 0 | 0 | **225** |
