...
Total tracked test files: **146**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 29 | 4 | 1 | 0 | 34 |
| **Total** | 94 | 61 | 5 | 1 | 0 | **161** |
...
| `system` | 34 | 0 | 0 | 0 | 0 | 0 | 34 |
| **Total** | 152 | 0 | 9 | 0 | 0 | 0 | **161** |
