...
Total tracked test files: **175**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 51 | 4 | 1 | 1 | 57 |
| **Total** | 95 | 107 | 5 | 1 | 1 | **209** |
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 65 | 0 | 9 | 0 | 0 | 0 | 74 |
| `tracking` | 30 | 0 | 0 | 0 | 0 | 0 | 30 |
| `cross-module` | 5 | 0 | 0 | 0 | 0 | 0 | 5 |
| `system` | 57 | 0 | 0 | 0 | 0 | 0 | 57 |
| **Total** | 200 | 0 | 9 | 0 | 0 | 0 | **209** |
