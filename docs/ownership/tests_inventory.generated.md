...
Total tracked test files: **168**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 48 | 4 | 1 | 1 | 54 |
| **Total** | 95 | 98 | 5 | 1 | 1 | **200** |
...
| `system` | 54 | 0 | 0 | 0 | 0 | 0 | 54 |
| **Total** | 191 | 0 | 9 | 0 | 0 | 0 | **200** |
