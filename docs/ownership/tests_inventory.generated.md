...
Total tracked test files: **155**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 47 | 20 | 1 | 0 | 0 | 68 |
| `tracking` | 8 | 11 | 0 | 0 | 0 | 19 |
| `cross-module` | 0 | 4 | 0 | 0 | 0 | 4 |
| `system` | 0 | 37 | 4 | 1 | 1 | 43 |
| **Total** | 94 | 76 | 5 | 1 | 1 | **177** |
...
| `tracking` | 19 | 0 | 0 | 0 | 0 | 0 | 19 |
| `cross-module` | 4 | 0 | 0 | 0 | 0 | 0 | 4 |
| `system` | 43 | 0 | 0 | 0 | 0 | 0 | 43 |
| **Total** | 168 | 0 | 9 | 0 | 0 | 0 | **177** |
