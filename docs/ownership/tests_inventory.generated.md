...
Total tracked test files: **192**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 56 | 4 | 1 | 1 | 62 |
| **Total** | 96 | 123 | 5 | 1 | 1 | **226** |
...
| `system` | 62 | 0 | 0 | 0 | 0 | 0 | 62 |
| **Total** | 217 | 0 | 9 | 0 | 0 | 0 | **226** |
