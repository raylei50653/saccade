...
Total tracked test files: **157**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 47 | 20 | 1 | 0 | 0 | 68 |
| `tracking` | 8 | 13 | 0 | 0 | 0 | 21 |
| `cross-module` | 0 | 4 | 0 | 0 | 0 | 4 |
| `system` | 0 | 39 | 4 | 1 | 1 | 45 |
| **Total** | 94 | 80 | 5 | 1 | 1 | **181** |
...
| `tracking` | 21 | 0 | 0 | 0 | 0 | 0 | 21 |
| `cross-module` | 4 | 0 | 0 | 0 | 0 | 0 | 4 |
| `system` | 45 | 0 | 0 | 0 | 0 | 0 | 45 |
| **Total** | 172 | 0 | 9 | 0 | 0 | 0 | **181** |
