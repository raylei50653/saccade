...
Total tracked test files: **145**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 28 | 4 | 1 | 0 | 33 |
| **Total** | 94 | 60 | 5 | 1 | 0 | **160** |
...
| `system` | 33 | 0 | 0 | 0 | 0 | 0 | 33 |
| **Total** | 151 | 0 | 9 | 0 | 0 | 0 | **160** |
