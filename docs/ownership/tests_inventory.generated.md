...
Total tracked test files: **159**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 47 | 20 | 1 | 0 | 0 | 68 |
| `tracking` | 8 | 15 | 0 | 0 | 0 | 23 |
| `cross-module` | 0 | 4 | 0 | 0 | 0 | 4 |
| `system` | 0 | 41 | 4 | 1 | 1 | 47 |
| **Total** | 94 | 84 | 5 | 1 | 1 | **185** |
...
| `tracking` | 23 | 0 | 0 | 0 | 0 | 0 | 23 |
| `cross-module` | 4 | 0 | 0 | 0 | 0 | 0 | 4 |
| `system` | 47 | 0 | 0 | 0 | 0 | 0 | 47 |
| **Total** | 176 | 0 | 9 | 0 | 0 | 0 | **185** |
