...
Total tracked test files: **151**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 47 | 20 | 1 | 0 | 0 | 68 |
| `tracking` | 8 | 8 | 0 | 0 | 0 | 16 |
| `cross-module` | 0 | 4 | 0 | 0 | 0 | 4 |
| `system` | 0 | 33 | 4 | 1 | 1 | 39 |
| **Total** | 94 | 69 | 5 | 1 | 1 | **170** |
...
| `tracking` | 16 | 0 | 0 | 0 | 0 | 0 | 16 |
| `cross-module` | 4 | 0 | 0 | 0 | 0 | 0 | 4 |
| `system` | 39 | 0 | 0 | 0 | 0 | 0 | 39 |
| **Total** | 161 | 0 | 9 | 0 | 0 | 0 | **170** |
...
| `test_h2_runtime_identity.py` | tracking,system | contract | active | The behavior axis must digest the declared members, and only those. |
...
| `test_runtime_identity_staleness.py` | tracking,system | contract | active | Version lag must be detected, and typed correctly. |
