...
Total tracked test files: **185**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 52 | 4 | 1 | 1 | 58 |
| **Total** | 96 | 116 | 5 | 1 | 1 | **219** |
...
| `system` | 58 | 0 | 0 | 0 | 0 | 0 | 58 |
| **Total** | 210 | 0 | 9 | 0 | 0 | 0 | **219** |
