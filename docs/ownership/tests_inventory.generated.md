...
Total tracked test files: **147**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 29 | 4 | 1 | 1 | 35 |
| **Total** | 94 | 61 | 5 | 1 | 1 | **162** |
...
| `system` | 35 | 0 | 0 | 0 | 0 | 0 | 35 |
| **Total** | 153 | 0 | 9 | 0 | 0 | 0 | **162** |
