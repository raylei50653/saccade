...
Total tracked test files: **169**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 49 | 4 | 1 | 1 | 55 |
| **Total** | 95 | 99 | 5 | 1 | 1 | **201** |
...
| `system` | 55 | 0 | 0 | 0 | 0 | 0 | 55 |
| **Total** | 192 | 0 | 9 | 0 | 0 | 0 | **201** |
