...
Total tracked test files: **162**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 47 | 20 | 1 | 0 | 0 | 68 |
| `tracking` | 8 | 18 | 0 | 0 | 0 | 26 |
| `cross-module` | 0 | 4 | 0 | 0 | 0 | 4 |
| `system` | 0 | 44 | 4 | 1 | 1 | 50 |
| **Total** | 94 | 90 | 5 | 1 | 1 | **191** |
...
| `tracking` | 26 | 0 | 0 | 0 | 0 | 0 | 26 |
| `cross-module` | 4 | 0 | 0 | 0 | 0 | 0 | 4 |
| `system` | 50 | 0 | 0 | 0 | 0 | 0 | 50 |
| **Total** | 182 | 0 | 9 | 0 | 0 | 0 | **191** |
