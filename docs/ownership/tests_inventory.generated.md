...
Total tracked test files: **153**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `reid` | 3 | 0 | 0 | 0 | 0 | 3 |
| `eval` | 47 | 20 | 1 | 0 | 0 | 68 |
| `tracking` | 8 | 10 | 0 | 0 | 0 | 18 |
| `cross-module` | 0 | 4 | 0 | 0 | 0 | 4 |
| `system` | 0 | 35 | 4 | 1 | 1 | 41 |
| **Total** | 94 | 73 | 5 | 1 | 1 | **174** |
...
| `tracking` | 18 | 0 | 0 | 0 | 0 | 0 | 18 |
| `cross-module` | 4 | 0 | 0 | 0 | 0 | 0 | 4 |
| `system` | 41 | 0 | 0 | 0 | 0 | 0 | 41 |
| **Total** | 165 | 0 | 9 | 0 | 0 | 0 | **174** |
