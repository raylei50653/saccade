...
Total tracked test files: **143**. Source of truth = each `test_*.py`'s own docstring + `# scope:` / `# function:` / `# lifecycle:` header; regenerate with `scripts/tools/build_tests_index.py`.
...
| `system` | 0 | 27 | 3 | 1 | 0 | 31 |
| **Total** | 94 | 59 | 4 | 1 | 0 | **158** |
...
| `system` | 31 | 0 | 0 | 0 | 0 | 0 | 31 |
| **Total** | 149 | 0 | 9 | 0 | 0 | 0 | **158** |
