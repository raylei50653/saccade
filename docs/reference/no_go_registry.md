...
| <a id="52"></a>52 | PP22 full-cadence + GT-interp training | Fix PP22 temporal cadence for Mamba training. | no transfer signal: cadence shaping did not survive T=1 deployment. | [PP22 cadence plan](../pp22_full_cadence_interp_training_plan.md), [PP22 findings](../pp22_stress_test_findings.md) |
| <a id="53"></a>53 | Detection-head architecture recall knobs | Use DFL, spatial reduction, or deeper YOLO-like head for deploy recall. | cost-bound / marginal: @0.001 gains do not map to deploy threshold. | [PP22 findings](../pp22_stress_test_findings.md), [details](no_go_registry_details.md) |
| <a id="54"></a>54 | PP22 full training as MOT17 transfer source | Use PP22 as training source for MOT17 deployment. | harmful / domain-bound: PP22 is better as a stress test than a transfer source. | [PP22 findings](../pp22_stress_test_findings.md), [details](no_go_registry_details.md) |
