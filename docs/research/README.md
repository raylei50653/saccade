...
| [capture_race_incidence_preregistration_20260908.md](pipeline/capture_race_incidence_preregistration_20260908.md) | #340 incidence closure 預註冊:兩條 path × 100 runs、failure 述詞、0/100 的 95% upper bound 措辭與 terminal 對照 |
| [capture_race_incidence_closure_20260908.md](pipeline/capture_race_incidence_closure_20260908.md) | 上述預註冊的 closure report:terminal `FAILURE_OBSERVED_B`、94 attempts / 93 ok / 1 failure / 0 invalid、不報 incidence rate,以及下一輪的兩項前置 blocker |
