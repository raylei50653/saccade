...
| [closed/capture_race_incidence_preregistration_20260909.md](pipeline/closed/capture_race_incidence_preregistration_20260909.md) | **closed** — 2026-09-09 #340 incidence 預註冊:production target `4afb57c3`、observer overlay、N=100 |
| [closed/capture_race_incidence_preregistration_20260909_seal.md](pipeline/closed/capture_race_incidence_preregistration_20260909_seal.md) | **closed** — 上述預註冊的 seal / pre-execution gate 記錄 |
| [closed/capture_race_incidence_closure_20260909.md](pipeline/closed/capture_race_incidence_closure_20260909.md) | **closed** — 上述預註冊的 closure report:terminal `CLOSED_BOUNDED`、Path A/B 各 0/100、one-sided 95% upper bound ≈ 2.95% per 7-sequence run;不關閉 mechanism / 歷史 901 |
