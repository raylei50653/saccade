...
| **[safe_region_asset_contract.md](safe_region_asset_contract.md)** | **R0-B RegionAsset 規範契約 — chat-side ACCEPTED**（RB1–RB9 PASS；R1 deterministic conversion authorized；A1/production not granted；§2.4 E1 editorial fix required before valid emission） |
