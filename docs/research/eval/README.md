...
| **[safe_region_asset_contract.md](safe_region_asset_contract.md)** | **R0-B RegionAsset 規範草稿**（R0-B-R2：RB5 realization／RB6 universe+predicate／RB7 policy AST；draft only；R1 unauthorized） |
