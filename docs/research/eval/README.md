...
| **[safe_region_asset_contract.md](safe_region_asset_contract.md)** | **R0-B RegionAsset 規範草稿**（identity／feasibility／claim ownership／machine schemas；draft only；R1 unauthorized） |
