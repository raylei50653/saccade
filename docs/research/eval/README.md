...
| **[safe_region_asset_contract.md](safe_region_asset_contract.md)** | **R0-B RegionAsset 規範草稿**（RB1–RB7 PASS；R0-B-R3 補 sealed-universe instance identity + threshold registry / concrete policy reconstruction；R1 unauthorized） |
