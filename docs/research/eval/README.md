...
| **[safe_region_asset_contract.md](safe_region_asset_contract.md)** | **R0-B RegionAsset 規範草稿**（R0-B-R3：RB8 universe contract/instance + RB9 threshold registry / policy instance；draft only；R1 unauthorized） |
