...
| *(pointer)* [merge_only_cross_dataset_20260924.md](../../modules/semantic/research/merge_only_cross_dataset_20260924.md) | 2026-09-24 merge-only 跨資料集 base vs merge 矩陣（#459；interp 交互作用 + dense OOM） |
