...
|:--|:--|:--|:--|:--|:--|:--|:--|
| `m.gate.portable_or_tail_hook` | **research default-off OR-tail hook** | eng / L2 path | m B1 freeze + e2e | ✅ **Stage 1 CLOSED** · e2e_safe · support mismatch | [`m_b1_hook_ab_20260710T062345Z`](../../../out/signal_study/m_b1_hook_ab_20260710T062345Z/) | [e2e close](../../modules/semantic/research/m_b1_hook_stage1_e2e_20260710.md) · [thread](../threads/m_b1_online_hook_20260709.md) | eng OK；A1≡B；elig**244**/rej**0**；offline rule **not online-portable**（\(D_{\text{offline}}\) vs \(D_{\text{online}}\)）；**e2e_safe=yes**；next=B-audit not thr re-fit；preset NO |
