...
|:--|:--|:--|:--|:--|:--|:--|:--|
| `m.gate.portable_or_tail_hook` | **research default-off OR-tail hook** | eng / L2 path | freeze + controls | 🔄 **Stage 1 OPEN** · 1a+1b eng PASSED | [`m_b1_hook_ab_20260710T064657Z_stage1b`](../../../out/signal_study/m_b1_hook_ab_20260710T064657Z_stage1b/) | [e2e](../../modules/semantic/research/m_b1_hook_stage1_e2e_20260710.md) · [thread](../threads/m_b1_online_hook_20260709.md) | **1a** entry OK；freeze B vacuous elig244/rej0；**1b** P atom0=168 rej=168 + F rej=elig=305 decisionΔ；strict A0 soft-only；B-audit/determinism **pending**；**overall OPEN**；preset NO |
