...
|:--|:--|:--|
| **ACTIVE** | **⏸️ 無 active（semantic）.** OWDL sealed 2026-09-20 at `declaration_seal_head = 311c2225…` and **parked** ([#442](https://github.com/raylei50653/saccade/issues/442) owner decision: seal, then park). No runner-review head or execution is scheduled; the seal freezes identity only. A later runner-review first gate is raw byte identity of the sealed declaration; mismatch is terminal. | [OWDL thread](observability_weighted_directional_likelihood_task.md) · [seal receipt](../../modules/semantic/research/observability_weighted_directional_likelihood_seal_receipt_20260920.json) · [semantic TODO](../../modules/semantic/TODO.md) |
...
H2 successor identity line (proposed; authorizes nothing)
  ...
  third authorization issued separately and spent 2026-08-04, executed once
    ...
    → inner 7/7 ∧ outer 7/7, each a separately executed verdict,
      host inputs unused
  ...
  ⇒ owner verdict 2026-08-04 at e4879d5f:
    ...
    ∧ the named limits and the adjudication are held only in
      successor_formal_measurement_executed.owner_review
...
|:--|:--|:--|:--|
| [observability_weighted_directional_likelihood_task.md](observability_weighted_directional_likelihood_task.md) | mainline-study · **parked** | **Sealed 2026-09-20** (`declaration_seal_head = 311c2225…`, [receipt](../../modules/semantic/research/observability_weighted_directional_likelihood_seal_receipt_20260920.json)); no runner-review scheduled; resume = owner scheduling decision + sealed-byte identity + 9/9 source identity (custody root recorded in receipt) | semantic |
