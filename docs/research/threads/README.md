...
|:--|:--|:--|
| [gt_support_morphology_20260711.md](gt_support_morphology_20260711.md) | **semantic sole active** · PR-A/B sealed · PR-C `ACCEPTED_WITH_LIMITS`（ROLE_REVERSAL_SUPPORTED；L1 single-seq）· next PR-D | semantic |
