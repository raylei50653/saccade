...
|:--|:--|:--|
| [safe_region_assetization_20260710.md](safe_region_assetization_20260710.md) | **semantic sole active** · R0-A accepted · R0-B final contract draft only · no asset generation | semantic |
