...
|:--|:--|:--|
| **ACTIVE** | **GCTM task charter** — activated 2026-07-22 (WP-A0, PR #250) by the owner scheduling decision on [#175](https://github.com/raylei50653/saccade/issues/175); substrate-agnostic A-layer theory/specification only (primary object = A). Active declaration **sealed at WP-A1**; **WP-A1–A8 landed** — [D1](../models/gap_conditioned_stochastic_transition_spec_v1.md) §2–§8 frozen (all four numbered obligations resolved; all D1 deliverable items complete) and [D2](../models/gap_conditioned_stochastic_transition_lemmas_v1.md) L1–L5 proved. **WP-A8 terminal review** selected terminal `GCTM_MODEL_SPEC_SEALABLE` ([checklist artifact](../models/gap_conditioned_stochastic_transition_terminal_review_v1.md)); **owner acceptance pending** — selection is not acceptance, and acceptance grants no B1/O1/online/production authority. H0 state unchanged. | [semantic TODO](../../modules/semantic/TODO.md) · [GCTM charter](gap_conditioned_stochastic_transition_model_task.md) |
| **NEXT** | Owner acceptance of the recorded terminal (charter decision procedure step 4), which closes the task and triggers the terminal-closure write-back. No work packet remains in the charter lease. B1 and O1 remain **proposed / non-WIP**, blocked by the gates below. | [GCTM charter](gap_conditioned_stochastic_transition_model_task.md) · [B1 charter](gctm_b1_runtime_grounded_offline_attribution_task.md) · [O1 charter](gctm_o1_online_intervention_efficacy_task.md) |
