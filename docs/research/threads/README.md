...
|:--|:--|:--|
| [gt_support_morphology_20260711.md](gt_support_morphology_20260711.md) | **semantic sole active** · PR-A/B/C sealed · PR-D gate `GLOBAL_PARTIAL_ORDER_READY`（global=bridge_dist/dist_h/log_h_ratio）· next restricted-closure prototype | semantic |
