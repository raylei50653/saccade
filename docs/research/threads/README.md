...
|:--|:--|:--|
| [gt_support_morphology_20260711.md](gt_support_morphology_20260711.md) | **semantic sole active** · PR-A/B/C sealed · PR-D gate `GLOBAL_PARTIAL_ORDER_READY`（global=dist_h/log_h_ratio；bridge_dist demoted）· next restricted-closure prototype | semantic |
