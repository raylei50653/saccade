...
|:--|:--|:--|
| [gt_support_morphology_20260711.md](gt_support_morphology_20260711.md) | **semantic sole active** · step-0 recorded（risk field 不可識別；μ_GT corner core + 4-track escape tail）· procedure v1 awaiting owner seal | semantic |
