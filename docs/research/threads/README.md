...
| **SUCCESSOR DESIGN** | **H2 — proposed / non-WIP. Current edge: W5a–W5e owner-accepted; W6 formal-measurement path is being implemented but has no grant.** W5 remains closed at `ACCEPT — W5 implementation/evidence closure`: its single final-projection diagnostic completed 4/4 runs, passed five predicates and independent 7/7 verification, then was correctly refused because diagnostic authority is not measurement authority. The separately selected W6 plan adds a successor-specific request/grant/durable-receipt envelope, v2 archive dispatch, outer independent closure and controlled-domain corpus admission. It reuses MOT17-04-SDP, four runs and the 454-key RunSpec, first through a disposable-ledger final-projection rehearsal. The accepted W5 witness exception-surface observation is repaired inside this projection-moving unit. **Implementation and rehearsal do not issue the third grant.** After review, the exact clean merged head may emit a request and must stop until the owner separately issues a matching grant. Intended success is owner-reviewed measurement closure plus canonical corpus admission; Phase B, equivalence, `I`/`F`/`S`, seal, H0 re-entry and any later execution remain unauthorized. Historical W5 packet custody remains `/home/ray/h2_w5e_diagnostic_20260803T132933Z`, inventory digest `c25baf48b8425543a1f430b83b0381bcc2dc72386398d54acf22e41103bea268`. Review Corrections 11–12 record the two distinct boundaries. H0's sealed history, five spent `S`, permanent ledger and two spent H2 grants are unchanged. | [H2 charter](h2_behavioral_identity_capture_task.md) · [H2 declaration](../../modules/semantic/research/headline_bridge_behavioral_identity_capture_declaration_20260725.md) · [claim-state registry](../contracts/claim_state_registry.md) |
...
| [h2_behavioral_identity_capture_task.md](h2_behavioral_identity_capture_task.md) | mainline-study · **non-WIP** | W5 implementation/evidence closure is owner-accepted. W6 now implements the separately selected formal-measurement path: successor-specific request/grant/durable receipt, v2 inner archive, outer authority envelope, controlled-domain corpus guard and disposable-ledger rehearsal. No grant exists; after a green exact-projection rehearsal and implementation review, emit a request from the clean merged head and stop for the owner's separate third grant. Two historical grants remain permanently spent. Formal success targets owner-reviewed measurement closure plus corpus admission only; no Phase B or equivalence follows. | semantic |
