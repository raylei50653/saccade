...
|:--|:--|:--|
| **ACTIVE** | **OWDL — WAITING_OWNER_SEAL.** Implementation complete; no formal outcome access authorized. Seal receipt, if issued, must record the exact merged commit SHA. A later runner-review first gate is raw byte identity of the sealed declaration; mismatch is terminal. | [OWDL thread](observability_weighted_directional_likelihood_task.md) · [semantic TODO](../../modules/semantic/TODO.md) · [study declaration](../../modules/semantic/research/observability_weighted_directional_likelihood_declaration_20260827.md) |
...
|:--|:--|:--|:--|
| [observability_weighted_directional_likelihood_task.md](observability_weighted_directional_likelihood_task.md) | mainline-study · **sole-active** | WAITING_OWNER_SEAL; implementation complete; no formal outcome access authorized | semantic |
