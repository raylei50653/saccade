...
|:--|:--|:--|
| **ACTIVE** | **Observability-weighted directional likelihood — pre-seal implementation only.** The active capability-map charter separates the low/high-\(q_v\) angular-concentration phenomenon from the OWDL-vs-raw held-out ranking gap. Formal B1 outcome execution, runtime inference, and score integration remain unauthorized. | [OWDL thread](observability_weighted_directional_likelihood_task.md) · [semantic TODO](../../modules/semantic/TODO.md) · [study declaration](../../modules/semantic/research/observability_weighted_directional_likelihood_declaration_20260827.md) |
...
|:--|:--|:--|:--|
| [observability_weighted_directional_likelihood_task.md](observability_weighted_directional_likelihood_task.md) | mainline-study · **sole-active** | Freeze and implement the pre-outcome OWDL score-ranking study; stop at owner seal review before formal B1 outcome execution | semantic |
