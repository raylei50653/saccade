...
| Terminals | T1 `RANKING_SIGNAL_PRESENT`→開 step ④ / T2 `NO_USABLE_RANKING_POWER`→封 family(step ⑤,unexplained residual set)/ T3 `NO_HEADROOM`→step ④ 不必要 / T0 `UNRESOLVED/INVALID-STUDY`→只關實驗 |
