...
| Cross-thread consequence (not handoff) | Door 0 T2 closes [GT-support morphology](../gt_support_morphology_20260711.md)'s score branch for this tested class; its gate branch remains parked. The independent D0 / #112 follow-up later closed in [gap-conditioned motion](gap_conditioned_probabilistic_motion_probe_20260711.md); it was never a Door 0 receiver. |
