...
After T0-A review, issue a bounded implementation task for the confirmed derivable subset of:
...
Only after completed T0-B evidence and review: decide T1 emit / region-LOO design / conditional G7 / close line.

## Global acceptance boundary

- T0 ultimately answers whether the 154 productive-safe cells are only dups / single-seq islands / thin strips, or any under-reported thickness.
- No production / hook / preset change.
- No new signal family; no unrestricted Boolean.
- Terminal B retained unless later evidence reopens gates with declared falsifiers.
