...
3. [Accepted R0-A preflight](../../modules/semantic/research/safe_region_r0_asset_contract_preflight_20260710.md)
...
| RB4 | pairwise full leaf swap before truth digest / coords / grid axes |
