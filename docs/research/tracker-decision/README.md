...
| [status_2026-07-09.md](status_2026-07-09.md) | **done (P8)** | One-page production narrative (contract, dual stab, NO-GO, closed topics) |
| [../paper_outline.md](../paper_outline.md) | **done (P8 skeleton)** | arXiv / tech-report outline only |
| [../evidence_ledger.md](../evidence_ledger.md) | **done (P8)** | Citable metrics + decision outcomes table |
