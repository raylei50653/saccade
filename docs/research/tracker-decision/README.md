...
| [audit/dual_stability_ablation_results_2026-07-09.md](audit/dual_stability_ablation_results_2026-07-09.md) | **done (P7 results)** | s/SDP/double-buffer A–D; recommend **keep both**; defaults unchanged |
