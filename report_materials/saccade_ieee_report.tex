...
% --- TikZ Styles ---
\tikzstyle{layer} = [rectangle, rounded corners, minimum width=3cm, minimum height=1cm, text centered, draw=black, fill=green!10, font=\small]
...
\begin{tikzpicture}[node distance=1.5cm]
    \node (ingest) [layer, fill=orange!10] {L0-L1: 邊緣硬體優化 (零拷貝)};
    \node (l2) [layer, below=0.8cm of ingest] {L2: 語義提取 (SigLIP 2)};
    \node (l4) [layer, below=0.8cm of l2, fill=blue!10] {L4: 向量資料庫 (ChromaDB)};
    \node (l5) [layer, right=1.2cm of l4, fill=purple!10, minimum width=2.5cm] {L5: 語義搜尋介面};
...
\section{實驗與效能評估}
我們在具備 12GB VRAM 的設備上模擬 4GB 邊緣環境進行測試。
