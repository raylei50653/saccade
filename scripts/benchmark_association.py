...
def run_benchmark(
    ...
    print(
        f"--- Benchmarking Association: MaxObjs={max_objs}, Dets={num_dets}, EmbedDim={embed_dim} ---"
    )
    ...
    for i in range(num_frames):
        torch.cuda.nvtx.range_push(f"Frame_{i}")  # type: ignore[no-untyped-call]
