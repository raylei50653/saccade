...
class BayesianOptimizer:
    def __init__(self, args):
        ...
        # Initialize study
        self.study_name = args.study_name or f"saccade_tuning_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
    ...
    def optimize(self):
        print(f"[{datetime.now().strftime('%H:%M:%S')}] 🚀 Starting Bayesian Optimization...")
...
if __name__ == "__main__":
    ...
    opt_group.add_argument("--n-trials", type=int, default=50, help="Number of Optuna trials.")
    opt_group.add_argument("--study-name", default=None, help="Optuna study name.")
    opt_group.add_argument("--formula", default=None, help="Formula for score (e.g. 'IDF1 + 0.5 * MOTA').")
    opt_group.add_argument("--params", default=None, help="Comma-separated list of parameter names to tune.")
