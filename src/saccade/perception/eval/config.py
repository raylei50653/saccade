...
def parse_eval_config(
    ...
    crop_hw = (256, 128) if reid_model in {"transreid", "osnet", "fastreid"} else (224, 224)
    ...
    post_lifecycle_appearance_gate = bool(kwargs.get("post_lifecycle_appearance_gate", False))
    post_lifecycle_appearance_weight = float(kwargs.get("post_lifecycle_appearance_weight", 0.0))
    ...
    return EvalConfig(
        ...
        semantic_clean_score_threshold=float(kwargs.get("semantic_clean_score_threshold", 0.60)),
        ...
        cross_tile_seam_area_ratio_threshold=float(kwargs.get("cross_tile_seam_area_ratio_threshold", 0.30)),
        cross_tile_seam_min_overlap_ratio=float(kwargs.get("cross_tile_seam_min_overlap_ratio", 0.45)),
        ...
        new_track_thresh=0.35 if kwargs.get("new_track_thresh", None) is None else float(kwargs.get("new_track_thresh")),
        ...
        narrow_person_max_width_ratio=float(kwargs.get("narrow_person_max_width_ratio", 0.018)),
        narrow_person_min_height_ratio=float(kwargs.get("narrow_person_min_height_ratio", 0.045)),
        ...
        post_lifecycle_appearance_threshold=float(kwargs.get("post_lifecycle_appearance_threshold", 0.90)),
        post_lifecycle_appearance_min_samples=max(1, int(kwargs.get("post_lifecycle_appearance_min_samples", 1))),
        post_lifecycle_appearance_max_samples=max(1, int(kwargs.get("post_lifecycle_appearance_max_samples", 5))),
        post_lifecycle_appearance_min_score=float(kwargs.get("post_lifecycle_appearance_min_score", 0.0)),
        post_lifecycle_appearance_min_consistency=float(kwargs.get("post_lifecycle_appearance_min_consistency", 0.0)),
        post_lifecycle_appearance_weight=post_lifecycle_appearance_weight,
        post_lifecycle_gap_uncertainty_weight=float(kwargs.get("post_lifecycle_gap_uncertainty_weight", 0.0)),
        post_lifecycle_consistency_weight=float(kwargs.get("post_lifecycle_consistency_weight", 0.0)),
        post_lifecycle_missing_appearance_cost=float(kwargs.get("post_lifecycle_missing_appearance_cost", 0.5)),
        ...
        appearance_bank_consistency_threshold=float(kwargs.get("appearance_bank_consistency_threshold", 0.75)),
        appearance_bank_high_quality_min_score=float(kwargs.get("appearance_bank_high_quality_min_score", 0.70)),
