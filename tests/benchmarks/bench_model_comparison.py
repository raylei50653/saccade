...
if __name__ == "__main__":
    ...
    results_26 = run_model_test(
        "YOLO26n (Saccade Native)", "./models/yolo/yolo26n.engine"
    )
    ...
    if results_11:
        print(
            f"{'YOLO11n (TRT)':<25} | {results_11['avg']:10.2f} | {results_11['p99']:10.2f} | {1000 / results_11['avg']:8.2f}"
        )
    if results_26:
        print(
            f"{'YOLO26n (Native TRT)':<25} | {results_26['avg']:10.2f} | {results_26['p99']:10.2f} | {1000 / results_26['avg']:8.2f}"
        )
    print("═" * 60)
